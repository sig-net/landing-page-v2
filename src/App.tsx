  ...
  return (
    <div className="bg-dark-neutral-950 min-h-screen text-white">
      ...
      <nav className="border-clam-shell-500 bg-clam-shell-50 border-b">
        ...
        <div className="border-clam-shell-500 flex h-[74px] items-center justify-between border-b xl:hidden">
        ...
        {isMobileMenuOpen && (
          <>
            ...
            <div
              className="fixed top-[104px] right-0 bottom-0 left-0 z-40 bg-black/50 xl:hidden"
              onClick={() => setIsMobileMenuOpen(false)}
            />
            {/* Menu Drawer */}
            <div className="border-clam-shell-500 bg-clam-shell-50 fixed top-[104px] right-0 left-0 z-50 shadow-lg xl:hidden">
              {navItems.map((item) => (
                <div
                  key={item}
              ...
              <div className="border-clam-shell-500 flex h-[74px] items-center border-b px-[20px]">
      ...
      <section className="border-clam-shell-500 bg-clam-shell-50 text-dark-neutral-600 relative overflow-hidden border-b">
        ...
        <div className="relative mx-auto max-w-[1440px] px-[60px] pt-[156px] pb-[82px] max-md:px-[20px] max-md:pt-[34px] max-md:pb-[27px]">
          ...
          <div className="font-mono-custom text-dark-neutral-600 mt-[21px] max-w-[632px] space-y-[15px] text-[16px] leading-[24px] max-md:mt-[33px] max-md:space-y-[9px] max-md:text-[12px] max-md:leading-[14px]">
            ...
            <p>
              For the first time, deploy on the chain you use and execute natively on
              every chain without restriction.
            </p>
          </div>
      ...
      {narrativeSlices.map((slice) => (
        <section key={slice.title} className="bg-dark-neutral-950">
          <TechnicalPanel src={slice.image} srcMobile={slice.imageMobile} alt={slice.alt} />
          <div
          ...
          <div className="mt-[40px] ml-[60px] grid grid-cols-3 gap-[62px] max-md:mt-12 max-md:ml-0 max-md:grid-cols-1 max-md:gap-[38px]">
            {principles.map((principle) => (
              <div
                ...
                className="border-dark-neutral-200 flex flex-col gap-[20px] border-t pt-0"
              >
            ...
            {releases.map((release, index) => (
              ...
              >
                <div className="flex shrink-0 flex-col items-start gap-[10px]">
                  ...
                  <p className="font-mono-custom text-dark-neutral-500 w-[200px] text-[16px] leading-[24px] opacity-80">
                    {release.date}
                  </p>
                </div>
                <h3 className="text-dark-neutral-200 w-[400px] shrink-0 text-[30px] leading-[38px] font-semibold max-md:w-full max-md:text-[28px]">
                  {release.title}
                </h3>
                <p className="font-mono-custom text-dark-neutral-500 flex-1 text-[16px] leading-[24px] opacity-85">
                  {release.description}
                </p>
              </div>
            ))}
